...
public static final String REST_SERVICE_URI="http://localhost:8080/formacion/restful";//Constante con la URI
public static void getAll(){
	...
	public void create(Alumno alumno){
		RestTemplate restTemplate= new RestTemplate();
		URI url= restTemplate.postForLocation(REST_SERVICE_URI+"alumnos/",alumno, Alumno.class);
	}
	public void update (Alumno alumno){
		RestTemplate restTemplate=new RestTemplate();
		restTemplate.put(REST_SERVICE_URI+"/"+alumno.getCodigo(),alumno, Alumno.class);
	}
