...
<form name="formcurso" class="" id="formcurso" method='post'
	...
	<div class="form-group">
		<label class="col-xs-2" for="<%=Constantes.PAR_TIPOCURSO%>">Tipo
			de curso:</label>
		<div class="col-xs-10">
			<select name="<%=Constantes.PAR_TIPOCURSO%>">
				...
				%>
				<option <%=curso.getTipo().equals(tipos[i]) ? "selected" : ""%>
	...
	<div class="form-group">
		<label class="col-xs-2" for="<%=Constantes.PAR_CODPATROCINADOR%>">Codigo
			del patrocinador:</label>
		<div class="col-xs-10">
			<input type="text" class="form-control "
				placeholder="Introduzca el nombre del Curso"
				name="<%=Constantes.PAR_CODPATROCINADOR%>"
				id="<%=Constantes.PAR_CODPATROCINADOR%>"
				value="<%=curso.getCodPatrocinador()%>" />
		</div>
	</div>
	<div class="form-group">
		<label class="col-xs-2" for="<%=Constantes.PAR_LISTADO_MODULOS%>"></label>
		<div class="col-xs-10">
			<%
			...
			<input type="checkbox" <%=checked%>
				name="<%=Constantes.PAR_LISTADO_MODULOS%>"
				value="<%=m.getCodigo()%>" />
			<%=m.getNombre()%>
	...
	<div class="form-group">
		<label class="col-xs-2" for="<%=Constantes.PAR_LISTADO_ALUMNOS%>"></label>
		<div class="col-xs-10">
			<%
	...
	<div class="form-group">
		<label class="col-xs-2">Alumnos totales:</label>
		<div class="col-xs-10">
	...
	<div class="form-group">
		<label class="col-xs-2">Modulos totales:</label>
		<div class="col-xs-10">
			<%=nHoras%>
			modulos
		</div>
