			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown"><a class="dropdown-toggle"
					data-toggle="dropdown" href="<%=Constantes.SERVLET_ALUMNOS%>">
						Alumnos </a>
					<ul class="dropdown-menu">
						<li><a href="<%=Constantes.SERVLET_ALUMNOS%>"> Todos los
								alumnos </a></li>
						<li><a
							href="<%=Constantes.SERVLET_ALUMNOS%>?<%=Constantes.PAR_CODIGO%>=<%=Alumno.CODIGO_ALUMNO%>">Crear
								Alumno Nuevo</a></li></li>
			</ul>
			</li>
			<li class="dropdown"><a class="dropdown-toggle"
				data-toggle="dropdown" href="<%=Constantes.SERVLET_MODULOS%>">
					Modulos </a>
				<ul class="dropdown-menu">
					<li><a href="<%=Constantes.SERVLET_MODULOS%>"> Ver Modulos
					</a></li>
					<li><a
						href="<%=Constantes.SERVLET_MODULOS%>?<%=Constantes.PAR_CODIGO%>=<%=Modulo.CODIGO_MODULO%>">Crear
							Modulo Nuevo</a></li>
				</ul></li>
			<li class="dropdown"><a class="dropdown-toggle"
				data-toggle="dropdown" href="<%=Constantes.SERVLET_ADMIN%>">
					Administracion </a>
				<ul class="dropdown-menu">
					<li><a href="<%=Constantes.SERVLET_ADMIN%>">Listado de
							usuarios conectados</a></li>
				</ul></li>
			</ul>
		</div>
	</nav>