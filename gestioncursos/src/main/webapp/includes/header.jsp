...
<c:choose>
	...
	<c:otherwise>
		<c:set var="language "
			value="<%=I18n.getBrowserLocale(response.getLocale())%>" />
	</c:otherwise>
</c:choose>
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						aria-expanded="false">ALUMNOS <span class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a href="<%=Constantes.SERVLET_ALUMNOS%>">Ver
									Alumnos </a></li>
							<li><a
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown" role="button">MODULOS <span
							class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a href="<%=Constantes.SERVLET_MODULOS%>">Ver
									Modulos </a></li>
							<li><a
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="<%=Constantes.SERVLET_ADMIN%>">Ver Usuarios
									Conectados </a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<a href="<%=Constantes.SERVLET_LOGOUT%>"
						class="btn btn-danger navbar-btn"> <fmt:message
