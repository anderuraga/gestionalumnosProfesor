...
<form name="" id="" method='post' class="form-horizontal"
	...
	<div class="form-group">
		...
		<div class="col-xs-10">
			<input type="text"
				pattern="((([A-Z]|[a-z])\d{8})|(\d{8}([A-Z]|[a-z])))"
				name="<%=Constantes.PAR_DNI%>" class="form-control"
				id="<%=Constantes.PAR_DNI%>" value="<%=alumno.getDni()%>" />
		</div>
	</div>
	<div class="form-group">
		<label class="col-xs-2" for="<%=Constantes.PAR_TELEFONO%>">Telefono:</label>
		<div class="col-xs-10">
			<input type="text" name="<%=Constantes.PAR_TELEFONO%>"
				class="form-control" id="<%=Constantes.PAR_TELEFONO%>"
	...
	<div class="form-group">
		...
		<div class="col-xs-10">
			<input type="text" name="<%=Constantes.PAR_EMAIL%>"
				class="form-control" id="<%=Constantes.PAR_EMAIL%>"
	...
	<div class="form-group">
		...
		<div class="col-xs-10">
			...
			<div class="row">
				<div class="col-xs-3">
					<label for="">Día</label> <input type="number"
						value="<%=calendar.get(GregorianCalendar.DAY_OF_MONTH)%>"
						class="form-control" min="1" max="31" step="1"
						name="<%=Constantes.PAR_DIA%>" />
				</div>
				<div class="col-xs-3">
					<label for="">Mes</label> <input type="number"
						value="<%=calendar.get(GregorianCalendar.MONTH) + 1%>"
						class="form-control" min="1" max="12" step="1"
				...
				<div class="col-xs-6">
					<label for="">Año</label> <input type="number"
						...
						class="form-control" min="" max="" name="<%=Constantes.PAR_ANYO%>" />
				</div>
			</div>
		</div>
	</div>
