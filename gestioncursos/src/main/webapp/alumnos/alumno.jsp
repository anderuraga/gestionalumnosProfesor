...
<%@page import="com.ipartek.formacion.services.Genero"%>
<%@page import="com.ipartek.formacion.control.exception.AlumnoError"%>
		...
		if(alumno!=null){
			%>
				<form name="" id="" method='post' class="form-horizontal"
					...
					<div class="form-group">
						<label class="col-xs-2">Cursos:</label>
						<div class="col-xs-10">
							<select name="<%=Constantes.PAR_CURSO %>">
								...
								if (cursos!=null){
									for (Curso curso: cursos){
										%>
										<!-- estaria mejor haciendo curso.equals(alumno.getCurso) 
										porque curso nunca será nulo, pero alumno get curso puede estar vacio -->
