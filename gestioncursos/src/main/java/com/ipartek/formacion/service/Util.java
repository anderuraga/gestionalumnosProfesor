...
import com.ipartek.formacion.pojo.DuracionHoras;
 ...
 */
   ...
   * @return duracion
   */
  public static DuracionHoras parseDuracion(String codDuracion) {
    DuracionHoras duracion = DuracionHoras.H15;
    int codigo = Integer.parseInt(codDuracion);
    if (codigo == DuracionHoras.H20.getCodigo()) {
      duracion = DuracionHoras.H20;
    } else {
      if (codigo == DuracionHoras.H45.getCodigo()) {
        duracion = DuracionHoras.H45;
      } else {
        if (codigo == DuracionHoras.H80.getCodigo()) {
          duracion = DuracionHoras.H80;
        } else {
          if (codigo == DuracionHoras.H90.getCodigo()) {
            duracion = DuracionHoras.H90;
          }
        }
      }
    }
   ...
   * @return duracion
   */
  public static DuracionHoras parseDuracion(int codDuracion) {
    DuracionHoras duracion = DuracionHoras.H15;
    if (codDuracion == DuracionHoras.H20.getCodigo()) {
      duracion = DuracionHoras.H20;
    } else {
      if (codDuracion == DuracionHoras.H45.getCodigo()) {
        duracion = DuracionHoras.H45;
      } else {
        if (codDuracion == DuracionHoras.H80.getCodigo()) {
          duracion = DuracionHoras.H80;
        } else {
          if (codDuracion == DuracionHoras.H90.getCodigo()) {
            duracion = DuracionHoras.H90;
          }
        }
      }
