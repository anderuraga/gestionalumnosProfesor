...
import com.ipartek.formacion.controller.filter.ServletFilter;

public class CursoAlumnos extends Curso {
	public final int CURSO_ALUMNO_CODIGO=-1;
	...
	public CursoAlumnos() {
		...
		setCodigoEmitido(CURSO_ALUMNO_CODIGO);
		setReferencia("");
		setFechaInicio(new Date(Long.MIN_VALUE));
		setFechaFin(new Date (Long.MAX_VALUE));
