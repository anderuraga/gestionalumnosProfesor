 ...
 * 
 * @author Curso
 * Clase que hereda de Curso, y contiene las notas de cada alumno.
 *
 */

public class CursoAlumnos extends Curso{
	public static final int CODIGO_CURSO_ALUMNO = -1;
	...
	public static int getCodigoCursoAlumno() {
		return CODIGO_CURSO_ALUMNO;
	}
