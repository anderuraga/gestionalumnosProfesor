...
public class CursoServlet extends HttpServlet {
  ...
  private void recogerDatos(HttpServletRequest request) {
    ...
    curso.setTipo(tipo);
    curso.setCodPatrocinador(request.getParameter(Constantes.PAR_CODPATROCINADOR));
    /*
     * //metodo para cargar el mapa de alumnos String[] codAlumnos =
     * request.getParameterValues(Constantes.PAR_LISTADO_ALUMNOS); Map<String,Alumno> alumnos =
     * getAlumnos(codAlumnos); curso.setAlumnos(alumnos); //metodo para cargar el mapa de modulos
     * String[] codModulos = request.getParameterValues(Constantes.PAR_LISTADO_MODULOS);
     * Map<Integer,Modulo> modulos = getModulos(codModulos); curso.setModulos(modulos);
     */
  }
