...
public class Constantes {
  ...
  public final static String PAR_LISTADO_USUARIOS = "list_de_usuarios";
  ...
  public final static String PAR_RECUERDAME = "recuerdame";
  public final static String PAR_SESIONID = "sesion_id";
  ...
  public final static DuracionModulo[] LISTA_DURACION = { DuracionModulo.HORAS15,
      DuracionModulo.HORAS20, DuracionModulo.HORAS45, DuracionModulo.HORAS80,
      DuracionModulo.HORAS90 };
  ...
  public final static String JSP_ADMINISTRACION = "/administracion/listadoUsuario.jsp";
