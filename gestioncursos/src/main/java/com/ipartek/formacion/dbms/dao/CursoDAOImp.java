...
public class CursoDAOImp implements CursoDAO{
	...
	//	LOG.trace(curso.toString());
		...
		try {
			...
			cStat.setString("nombreCurso", curso.getNombre());
			cStat.setString("codPatrocinador", curso.getCodPatrocinador());
			LOG.trace(curso.getTipoCurso().getCodigo());
			cStat.setInt("tCurso", curso.getTipoCurso().getCodigo());
	...
	public Curso parseCurso(ResultSet rS) {
		...
		try {
			...
			TipoCurso tipo = Util.parseTipoCurso(tipoCurso);
			aux.setTipoCurso(tipo);
