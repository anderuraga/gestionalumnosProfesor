...
public class InitListener implements ServletContextListener, ServletContextAttributeListener {
  ...
  private void loadProperties(ServletContextEvent sce) {
    ...
    InputStream constantes = classLoader.getResourceAsStream("constantes.properties");
    InputStream database = classLoader.getResourceAsStream("database.properties");
    Properties props = new Properties();
    try {
      props.load(constantes);
      props.load(database);
    } catch (Exception e) {
