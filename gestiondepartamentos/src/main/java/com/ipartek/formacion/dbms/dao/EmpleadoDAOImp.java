...
public class EmpleadoDAOImp implements EmpleadoDAO {
	...
	public Empleado CreateEmpleado(Empleado empleado) {
		...
		try {
			...
			cSmt.setDate("date_nacimiento", new Date(empleado
					.getDate_nacimiento().getTime()));
			cSmt.setDate("date_contratacion", new Date(empleado
					.getDate_contratacion().getTime()));
			cSmt.setString("num_seg_soc", empleado.getNum_seg_soc());
			cSmt.setString("num_dni", empleado.getNum_dni());
			cSmt.setString("num_cuenta_corriente",
					empleado.getCuenta_corriente());
			...
			cSmt.setInt("pertenece_departamento", empleado
					.getDepartamento_empleado().getCodigo());
			cSmt.executeUpdate();
			emple = empleado;
