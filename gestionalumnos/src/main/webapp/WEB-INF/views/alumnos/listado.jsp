				...
				<div class="table-responsive">
					<table class="table">
						<tr>
							...
							<td></td>
							<td><a href="alumnos/<%=a.getCodigo()%>"
								class="btn btn-default">Modificar Alumno</a></td>
								<td><form action="delete/alumnos/<%=a.getCodigo()%>" method="post">
								<BUTTON class="btn btn-default">Borrar Alumno</BUTTON></form></td>
							<%
								}
								} else {
							%>
							<td>No se han encontrado alumnos en la BB.DD.</td>
							<%
								}
							%>
						</tr>
