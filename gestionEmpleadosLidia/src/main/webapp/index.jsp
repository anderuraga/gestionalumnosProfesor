		...
		<div class="col-xs-12 col-md-4 col-md-offset-4">
			<div class="panel panel-success" >
				...
				<div class="panel-body">
					...
					<!--cargar de properties -->
						<form  class="form-horizontal"action="${loginServlet}" method="post" name="loginForm">
							...
							<div class="form-group">
								<div class="input-group">
									<span class="input-group-addon" id="basic-addon2"><i class="fa fa-lock"></i></span> <input
										type="password" name="${constantes.password}" class="form-control" placeholder="password"
